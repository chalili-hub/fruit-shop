  ...
  async confirmAddTableCode() {
    ...
    try {
      ...
      const addRes = await db.collection('tableCode').add({
        data: {
          tableNumber: tableNumber,
          inviteCode: tableNumber, // 邀请码，用于分享和记录邀请关系
          creatorOpenid: app.globalData.openid, // 创建者openid
          qrCodeUrl: qrCodeUrl,
